...
export const MOCK_BADGES: Badge[] = [
  {
    id: 1,
    name: 'Primer Gol',
    description: 'Acertaste tu primer marcador exacto.',
    icon: 'emoji_events',
    unlocked: true,
    progress: 100,
  },
  {
    ...
    description: 'Predice 5 partidos consecutivos.',
  ...
  },
  {
    id: 3,
    name: 'Analista Pro',
    description: 'Llega a 100 puntos acumulados.',
    icon: 'analytics',
    unlocked: false,
    progress: 72,
  },
...
export const MOCK_PREDICTIONS: PredictionDTO[] = [
  {
    id: 11,
    userId: 7,
    matchId: 1,
    ...
    awayTeam: 'Canada',
    predictionTypeId: 1,
    predictionType: 'Marcador exacto',
    predictionValue: '2-1',
    points: 8,
    isLocked: true,
...
export const MOCK_COMMENTS: SocialComment[] = [
  {
    ...
    matchId: 1,
    user: 'Ana Torres',
    content: 'Mexico esta presionando alto, se viene otro gol.',
  ...
  },
  {
    ...
    matchId: 1,
    user: 'Diego Ramos',
    content: 'Canada necesita cambiar el mediocampo ya.',
